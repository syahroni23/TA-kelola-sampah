		...
		<div class="content-wrapper">
			<section class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1 class="m-0">Detail Pengambilan Saldo</h1>
						</div>
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								<li class="breadcrumb-item"><a href="../../beranda">Beranda</a></li>
								<li class="breadcrumb-item"><a href="../../pengambilan-saldo">Pengambilan Saldo</a></li>
								<li class="breadcrumb-item active">Detail Pengambilan Saldo</li>
							</ol>
						</div>
					</div>
				</div>
											...
											<div class="row">
												...
												<div class="col-lg-6 col-md-12">
													<div class="form-group">
														...
														<input type="text" name="nominal" id="nominal" class="form-control currency" autocomplete="off" placeholder="Masukkan Nominal" minlength="1" maxlength="14" disabled="" value="<?= $row['nominal'];?>">
													</div>
												</div>
												<div class="col-lg-6 col-md-12">
													<div class="form-group">
												...
												<div class="col-lg-4 col-md-12">
													<div class="form-group">
														<label for="m_bank_id">Bank</label>
														<select class="form-control select2 width-100" name="m_bank_id" id="m_bank_id" disabled="">
												...
												<div class="col-lg-4 col-md-12">
													<div class="form-group">
														...
														<input type="text" name="nomor_rekening" id="nomor_rekening" class="form-control" autocomplete="off" placeholder="Masukkan Nomor Rekening" minlength="1" maxlength="50" disabled="" onkeypress="return onlyNumber(event);" value="<?= $row['nomor_rekening'];?>">
													</div>
												</div>
												<div class="col-lg-4 col-md-12">
													<div class="form-group">
														<label for="atas_nama">Atas Nama</label>
														<input type="text" name="atas_nama" id="atas_nama" class="form-control" autocomplete="off" placeholder="Masukkan Atas Nama" minlength="1" maxlength="100" disabled="" value="<?= $row['atas_nama'];?>">
													</div>
												</div>
											</div>
										</form>
