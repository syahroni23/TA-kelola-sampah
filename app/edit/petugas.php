...
$query = mysqli_query($conn, "SELECT * FROM m_petugas WHERE id = '$id' AND is_deleted = 0");
											...
											<div class="row">
												<div class="col-lg-6 col-md-12">
													<div class="form-group">
														...
														<input type="text" name="nama" id="nama" class="form-control" autocomplete="off" placeholder="Masukkan Nama Petugas" required="" minlength="1" maxlength="100" autofocus="" value="<?= $row['nama'];?>">
													</div>
												</div>
												<div class="col-lg-6 col-md-12">
													<div class="form-group">
