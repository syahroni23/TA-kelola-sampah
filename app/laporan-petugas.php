...
if(isset($rowAkses)) {
	...
	checkAccessUser('laporan-petugas', $getAkses);
		...
		<div class="content-wrapper">
			<section class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1 class="m-0">Laporan Petugas</h1>
						</div>
						<div class="col-sm-6">
					...
					<div class="row">
						<div class="col-lg-12 col-md-12">
							<div class="card card-primary card-outline loading-card">
								...
								<div class="card-body">
									<form role="form" action="../routes/web/laporan-petugas.php" method="POST" enctype="multipart/form-data" id="data-form">
