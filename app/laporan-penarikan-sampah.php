...
if(isset($rowAkses)) {
	...
	checkAccessUser('laporan-penarikan-sampah', $getAkses);
		...
		<div class="content-wrapper">
			<section class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1 class="m-0">Laporan Penarikan Sampah</h1>
						</div>
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								<li class="breadcrumb-item"><a href="beranda">Beranda</a></li>
								<li class="breadcrumb-item active">Laporan Penarikan Sampah</li>
							</ol>
						</div>
					</div>
				</div>
					...
					<div class="row">
						<div class="col-lg-12 col-md-12">
							<div class="card card-primary card-outline loading-card">
								...
								<div class="card-body">
									<form role="form" action="../routes/web/laporan-penarikan-sampah.php" method="POST" enctype="multipart/form-data" id="data-form">
