										...
										<div class="row">
											<div class="col-lg-6 col-md-12">
												<div class="form-group">
													...
													<input type="text" name="nama" id="nama" class="form-control" autocomplete="off" placeholder="Masukkan Nama Pelanggan" required="" minlength="1" maxlength="100" autofocus="">
												</div>
											</div>
											<div class="col-lg-6 col-md-12">
												<div class="form-group">
