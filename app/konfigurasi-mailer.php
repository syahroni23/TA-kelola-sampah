...
if(isset($rowAkses)) {
	...
	checkAccessUser('konfigurasi-mailer', $getAkses);
	checkMaintenance($rowAkses, $rowUmum);
}
?>
<?php
$query = mysqli_query($conn, "SELECT * FROM p_konfigurasi_mailer ORDER BY id ASC LIMIT 1");
...
<body class="hold-transition sidebar-mini layout-fixed layout-footer-fixed layout-navbar-fixed">
		...
		<div class="content-wrapper">
			<section class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1 class="m-0">Konfigurasi Mailer</h1>
						</div>
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								<li class="breadcrumb-item"><a href="beranda">Beranda</a></li>
								<li class="breadcrumb-item active">Konfigurasi Mailer</li>
							</ol>
						</div>
					</div>
				</div>
										...
										<div class="row">
											<div class="col-lg-4 col-md-12">
												<div class="form-group">
													<label for="host" class="input-required">Host</label>
													<input type="text" name="host" id="host" class="form-control" autocomplete="off" placeholder="Masukkan Host" required="" minlength="2" autofocus="" value="<?= $row['host'];?>">
												</div>
											</div>
											<div class="col-lg-4 col-md-12">
												<div class="form-group">
													<label for="secure" class="input-required">Secure</label>
													<input type="text" name="secure" id="secure" class="form-control" autocomplete="off" placeholder="Masukkan Secure" required="" minlength="2" autofocus="" value="<?= $row['secure'];?>">
												</div>
											</div>
											<div class="col-lg-4 col-md-12">
												<div class="form-group">
													<label for="port" class="input-required">Port</label>
													<input type="number" name="port" id="port" class="form-control" autocomplete="off" placeholder="Masukkan Port" required="" autofocus="" value="<?= $row['port'];?>">
												</div>
											</div>
											<div class="col-lg-4 col-md-12">
												<div class="form-group">
													<label for="name" class="input-required">Name</label>
													<input type="text" name="name" id="name" class="form-control" autocomplete="off" placeholder="Masukkan Name" required="" minlength="5" autofocus="" value="<?= $row['name'];?>">
												</div>
											</div>
											<div class="col-lg-4 col-md-12">
												<div class="form-group">
	...
	<script type="text/javascript">
		$("#data-form").submit(function(e) {
			...
			data.append('function', 'updateKonfigurasiMailer');
