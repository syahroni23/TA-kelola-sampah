...
<body class="hold-transition sidebar-mini layout-fixed layout-footer-fixed layout-navbar-fixed">
		...
		<div class="content-wrapper">
			<section class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1 class="m-0">Pengisian Saldo</h1>
						</div>
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								<li class="breadcrumb-item"><a href="beranda">Beranda</a></li>
								<li class="breadcrumb-item active">Pengisian Saldo</li>
							</ol>
						</div>
					</div>
				</div>
						...
						<div class="col-lg-12 col-md-12">
							<div class="card card-primary card-outline loading-card">
								<div class="card-header">
									<h3 class="card-title margin-top-five">Daftar Pengisian Saldo</h3>
									<div class="card-tools">
										<div class="btn-group">
											...
											<a href="add/pengisian-saldo" alt="Buat Baru" class="btn btn-sm btn-primary<?= isDisabledHref($isPengajuan);?>">
									...
									<div class="row">
										<div class="col-lg-12 col-md-12">
											<div class="table-responsive">
												<table class="table table-striped table-hover table-bordered" width="100%" id="datatables-serverside">
													<thead>
														<tr>
															...
															<th style="text-align: center; width: 8%;">Bukti</th>
		...
		<div class="modal-dialog modal-sm" role="document">
			<div class="modal-content loading-card">
				<div class="modal-header">
					<h5 class="modal-title" id="viewDataLabel">Bukti Transfer</h5>
				...
				<form role="form" action="#" method="POST" enctype="multipart/form-data" id="data-form-view">
					...
					<div class="modal-footer" id="isTampilkanUpload">
						<button type="submit" class="btn btn-sm btn-primary btn-save"><i class="fas fa-save"></i> Unggah</button>
					</div>
				</form>
			</div>
		</div>
	...
	<!-- JS Manual -->
	<script type="text/javascript" src="<?= clearCacheFile('page/pengisian-saldo.js');?>"></script>
</body>
</html>