...
<body class="hold-transition sidebar-mini layout-fixed layout-footer-fixed layout-navbar-fixed">
						...
						<div class="col-lg-12 col-md-12">
							<div class="card card-primary card-outline loading-card">
								<div class="card-header">
									<h3 class="card-title margin-top-five">Daftar Pelanggan</h3>
									<div class="card-tools">
										<div class="btn-group">
											...
											<a href="add/pelanggan" alt="Buat Baru" class="btn btn-sm btn-primary">
	...
	<!-- JS Manual -->
	<script type="text/javascript" src="<?= clearCacheFile('page/pelanggan.js');?>"></script>
