...
<body class="hold-transition sidebar-mini layout-fixed layout-footer-fixed layout-navbar-fixed">
						...
						<div class="col-lg-12 col-md-12">
							<div class="card card-primary card-outline loading-card">
								<div class="card-header">
									<h3 class="card-title margin-top-five">Daftar Hak Akses</h3>
									<div class="card-tools">
										<div class="btn-group">
											...
											<a href="add/hak-akses" alt="Buat Baru" class="btn btn-sm btn-primary">
													...
													<div class="col-lg-12 col-md-12">
														<div class="row">
															...
															<div class="col-lg-3 col-md-12">
																<div class="form-group row">
																	<div class="col-sm-12">
																		<select class="form-control select2" name="isStatusAkses" id="isStatusAkses" style="width: 100% !important;">
																			<option value="Semua">Semua Status Akses</option>
												...
												<table class="table table-striped table-hover" width="100%" id="datatables-serverside">
													<thead>
														<tr>
															...
															<th style="text-align: left;">Nama Hak Akses</th>
															<th style="text-align: center; width: 15%;">Status Akses</th>
	...
	<!-- JS Manual -->
	<script type="text/javascript" src="<?= clearCacheFile('page/hak-akses.js');?>"></script>
</body>
</html>