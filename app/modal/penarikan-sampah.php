...
<div class="row">
	<div class="col-lg-12 col-md-12">
		<?php if( issetEmpty($row['latitude']) && issetEmpty($row['longitude']) && ($row['latitude'] != "" && $row['longitude'] != "") && ($row['latitude'] != "-" && $row['longitude'] != "-") ) { ?>
			<input type="hidden" name="latitude_umum" id="latitude_umum" value="<?= $latitudeUmum;?>">
			<input type="hidden" name="longitude_umum" id="longitude_umum" value="<?= $longitudeUmum;?>">
			<input type="hidden" name="nama_alamat_umum" id="nama_alamat_umum" value="<?= $namaAlamatUmum;?>">
			<div class="row">
				...
				<div class="col-lg-12 col-md-12">
					<div class="form-group">
						<label for="jarak">Jarak ke Petugas <?= $namaAlamatUmum;?></label>
			...
			<div class="row">
				<div class="col-lg-12 col-md-12">
					<div class="alert alert-info">
						...
						<ol type="number">
							<li>Titik Lokasi A merupakan lokasi pelanggan <?= $row['nama'];?>.</li>
							<?php if($isPetugasAlamat == true) { ?>
								<li>Titik Lokasi B merupakan lokasi petugas <?= $namaAlamatUmum;?>.</li>
							<?php }else { ?>
								<li>Titik Lokasi B merupakan lokasi <?= $namaAlamatUmum;?>.</li>
							<?php } ?>
						</ol>
					</div>
				</div>
