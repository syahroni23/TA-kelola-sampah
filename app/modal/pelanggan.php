...
$id = $_POST['id'];
$query = mysqli_query($conn, "SELECT m_pelanggan.*, CONCAT(ROUND(ST_Distance_Sphere(POINT(".$longitudeUmum.", ".$latitudeUmum."), POINT(m_pelanggan.longitude, m_pelanggan.latitude)), 2), 'm') AS jarak FROM m_pelanggan WHERE m_pelanggan.id = '$id'");
