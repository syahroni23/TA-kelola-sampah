...
<body class="hold-transition sidebar-mini layout-fixed layout-footer-fixed layout-navbar-fixed">
						...
						<div class="col-lg-12 col-md-12">
							<div class="card card-primary card-outline loading-card">
								<div class="card-header">
									<h3 class="card-title margin-top-five">Daftar Aktivitas Log</h3>
												...
												<table class="table table-striped table-hover" width="100%" id="datatables-serverside">
													<thead>
														<tr>
															...
															<th style="text-align: left; width: 18%;">IP Address</th>
															<th style="text-align: left; width: 15%;">Browser</th>
		...
		<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content loading-card">
				<div class="modal-header">
					<h5 class="modal-title" id="viewDataLabel">Informasi Aktivitas Log</h5>
	...
	<!-- JS Manual -->
	<script type="text/javascript" src="<?= clearCacheFile('page/aktivitas-log.js');?>"></script>
</body>
</html>